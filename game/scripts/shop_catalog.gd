...
#
#           DERIVED, NOT PICKED, because the moment fuel is a real constraint
#           an arbitrary number here becomes the balance. It was arbitrary:
#           burn per aircraft-HOUR - which is what a regenerating supply
#           actually meets - ran from 5 to 1,500 across the ladder, a spread
#           of 330x with no pattern in it. The level 36 CRJ-700 burned 1,500
#           an hour and the level 30 balloon burned 5. Nobody noticed because
#           fuel has never bound: BALANCE.md measures it at 0.3-0.8% of income
#           with one blocked pass in four full runs.
#
#           The rule is a target burn per hour, set by level, converted to a
#           per-leg number by how long that aircraft's leg takes:
#
#               fuel = target_fph(level) * leg_minutes / (60 * range)
#               target_fph(level) = 120 * (250/120) ^ ((level - 1) / 83)
#
#           So 120 units an hour at level 1 rising to 250 at level 84 - a
#           deliberate 2x over the whole ladder rather than an accidental
#           330x. Rounded to readable steps (5s under 200, 10s under 1000,
#           50s above), which is what puts the DC-3 back on exactly the 4 it
#           already had: the early game was on the curve all along.
#
#           Payout per unit of fuel still spreads about 39x, and that is the
#           progression rather than a fault - with burn tied to hours, fuel
#           efficiency IS payout per hour, so climbing the ladder is what
#           buys you more money per barrel.
#
#           Two aircraft are off the curve on purpose and stay at 0: the
#           Paper Plane, whose whole lesson is that it burns nothing, and
#           the UFO.
...
const ENTRIES := [
	...
	{"key": "emb120", "name": "EMB-120", "icon": "emb120_default.png", "price": 5000, "level": 10,
		"force": "A", "seats": 80, "fuel": 9, "xp": 42, "range": 2, "has_world_sprite": true},
	...
	{"key": "dc4", "name": "DC-4", "icon": "dc4_default.png", "price": 8000, "level": 10,
		"force": "C", "seats": 200, "fuel": 32, "xp": 150, "ticket": 2.5, "range": 3, "has_world_sprite": true},
	# ---- levels 11-20 ------------------------------------------------
	{"key": "dhc8", "name": "Dash 8", "icon": "dhc8_default.png", "price": 14000, "level": 11,
		"force": "A", "seats": 120, "fuel": 9, "xp": 67, "range": 2, "has_world_sprite": true},
	...
	{"key": "328jet", "name": "328 Jet", "icon": "328jet_blue.png", "price": 23000, "level": 13,
		"force": "S", "seats": 110, "fuel": 15, "xp": 110, "range": 3, "has_world_sprite": true},
	...
	{"key": "atr72", "name": "ATR 72", "icon": "atr72_default.png", "price": 40000, "level": 15,
		"force": "A", "seats": 100, "fuel": 5, "xp": 170, "range": 1, "has_world_sprite": true},
	...
	{"key": "an140", "name": "An-140", "icon": "an140_default.png", "price": 50000, "level": 20,
		"force": "C", "seats": 150, "fuel": 17, "xp": 200, "range": 2, "has_world_sprite": true},
	# ---- levels 21-30 ------------------------------------------------
	{"key": "dc6", "name": "DC-6", "icon": "dc6_default.png", "price": 59000, "level": 22,
		"force": "C", "seats": 175, "fuel": 35, "xp": 220, "range": 3, "has_world_sprite": true},
	# LIVE 70000/D/200/30/3cl.
	{"key": "tu104", "name": "Tu-104", "icon": "tu104_default.png", "price": 70000, "level": 25,
		"force": "D", "seats": 200, "fuel": 43, "xp": 250, "range": 3, "has_world_sprite": true},
	...
	{"key": "erj145", "name": "ERJ-145", "icon": "erj145_default.png", "price": 70000, "level": 25,
		"force": "C", "seats": 200, "fuel": 17, "xp": 500, "ticket": 7.5, "range": 2, "has_world_sprite": true},
	{"key": "a318", "name": "A318", "icon": "a318_default.png", "price": 77000, "level": 27,
		"force": "C", "seats": 235, "fuel": 37, "xp": 260, "range": 3, "has_world_sprite": true},
	{"key": "a319", "name": "A319", "icon": "a319_default.png", "price": 84000, "level": 28,
		"force": "C", "seats": 280, "fuel": 37, "xp": 270, "range": 3, "has_world_sprite": true},
	...
	{"key": "a220", "name": "A220-300", "icon": "a220_default.png", "price": 91000, "level": 29,
		"force": "C", "seats": 290, "fuel": 100, "xp": 290, "range": 4, "has_world_sprite": true},
	...
	{"key": "uss51", "name": "USS 51", "icon": "uss51_default.png", "price": 20, "currency": COINS, "level": 29,
		"force": "C", "seats": 100, "fuel": 310, "xp": 420, "ticket": 80, "range": 5, "has_world_sprite": true},
	...
	{"key": "balloon", "name": "Hot Air Balloon", "icon": "balloon_default.png", "price": 20, "currency": COINS, "level": 29,
		"force": "D", "seats": 50, "fuel": 340, "xp": 420, "ticket": 200, "range": 5, "has_world_sprite": true},
	...
	{"key": "b727", "name": "Tu-154", "icon": "b727_default.png", "price": 100000, "level": 30,
		"force": "E", "seats": 300, "fuel": 370, "xp": 300, "range": 5, "has_world_sprite": true},
	# ---- levels 31-40 ------------------------------------------------
	# The rating-4 threshold.
	{"key": "b707", "name": "707", "icon": "b707_default.png", "price": 110000, "level": 31,
		"force": "D", "seats": 320, "fuel": 120, "xp": 300, "range": 4, "has_world_sprite": true},
	...
	{"key": "f15", "name": "F-15", "icon": "f15_default.png", "price": 25, "currency": COINS, "level": 31,
		"force": "B", "seats": 2, "fuel": 280, "xp": 500, "ticket": 1875, "range": 5, "has_world_sprite": true},
	...
	{"key": "banshee", "name": "Banshee", "icon": "banshee_default.png", "price": 30, "currency": COINS, "level": 31,
		"force": "B", "seats": 12, "fuel": 280, "xp": 1500, "ticket": 333.33, "range": 5, "has_world_sprite": true},
	{"key": "v22", "name": "V-22", "icon": "v22_green.png", "price": 130000, "level": 33,
		"force": "B", "seats": 390, "fuel": 90, "xp": 300, "range": 4, "has_world_sprite": true},
	...
	{"key": "ncc1701", "name": "NCC-1701", "icon": "ncc1701_default.png", "price": 40, "currency": COINS, "level": 33,
		"force": "D", "seats": 200, "fuel": 350, "xp": 5000, "ticket": 50, "range": 5, "has_world_sprite": true},
	...
	{"key": "camel", "name": "Camel", "icon": "camel_default.png", "price": 80, "currency": COINS, "level": 33,
		"force": "C", "seats": 2, "fuel": 320, "xp": 5000, "ticket": 4500, "range": 5, "has_world_sprite": true},
	...
	{"key": "b787", "name": "787", "icon": "b787_default.png", "price": 150000, "level": 34,
		"force": "E", "seats": 400, "fuel": 390, "xp": 300, "range": 5, "has_world_sprite": true},
	...
	{"key": "md11", "name": "MD-11", "icon": "md11_default.png", "price": 150000, "level": 34,
		"force": "E", "seats": 625, "fuel": 390, "xp": 600, "ticket": 8, "range": 5, "has_world_sprite": true},
	{"key": "dc10", "name": "DC-10", "icon": "dc10_default.png", "price": 210000, "level": 35,
		"force": "E", "seats": 250, "fuel": 390, "xp": 450, "ticket": 8, "range": 5, "has_world_sprite": true},
	...
	{"key": "a340-early", "name": "A340", "icon": "a340-early_default.png", "price": 250000, "level": 36,
		"force": "E", "seats": 550, "fuel": 390, "xp": 700, "ticket": 7.5, "range": 5, "has_world_sprite": true},
	...
	{"key": "crj700", "name": "CRJ-700", "icon": "crj700_default.png", "price": 300000, "level": 36,
		"force": "A", "seats": 200, "fuel": 5, "xp": 1250, "range": 1, "has_world_sprite": true},
	...
	{"key": "c800", "name": "C800", "icon": "c800_default.png", "price": 350000, "level": 37,
		"force": "B", "seats": 250, "fuel": 15, "xp": 1250, "ticket": 8, "range": 2, "has_world_sprite": true},
	...
	{"key": "il62", "name": "IL-62", "icon": "il62_default.png", "price": 400000, "level": 38,
		"force": "C", "seats": 400, "fuel": 41, "xp": 1500, "range": 3, "has_world_sprite": true},
	...
	{"key": "a300", "name": "A300", "icon": "a300_default.png", "price": 450000, "level": 39,
		"force": "D", "seats": 500, "fuel": 125, "xp": 2000, "ticket": 8, "range": 4, "has_world_sprite": true},
	# ---- levels 41-50 ------------------------------------------------
	...
	{"key": "b747", "name": "747", "icon": "b747_default.png", "price": 500000, "level": 41,
		"force": "E", "seats": 500, "fuel": 410, "xp": 2500, "ticket": 10, "range": 5, "has_world_sprite": true},
	...
	{"key": "a380-300", "name": "A380", "icon": "a380-300_default.png", "price": 1000000, "level": 42,
		"force": "E", "seats": 875, "fuel": 410, "xp": 4000, "ticket": 10, "range": 5, "has_world_sprite": true},
	{"key": "concorde", "name": "Concorde", "icon": "concorde_default.png", "price": 2000000, "level": 42,
		"force": "D", "seats": 1000, "fuel": 380, "xp": 4000, "range": 5, "has_world_sprite": true},
	{"key": "airship", "name": "Airship", "icon": "airship_default.png", "price": 4000000, "level": 43,
		"force": "E", "seats": 1500, "fuel": 420, "xp": 7500, "range": 5, "has_world_sprite": true},
	...
	{"key": "a350-900", "name": "A350-900", "icon": "a350-900_default.png", "price": 4500000, "level": 44,
		"force": "E", "seats": 530, "fuel": 420, "xp": 8700, "ticket": 25, "range": 5, "has_world_sprite": true},
	{"key": "an-225", "name": "An-225", "icon": "an-225_default.png", "price": 5000000, "level": 45,
		"force": "E", "seats": 2000, "fuel": 420, "xp": 10000, "range": 5, "has_world_sprite": true},
	...
	{"key": "b777-300er", "name": "777-300ER", "icon": "b777-300er_default.png", "price": 8700000, "level": 45,
		"force": "E", "seats": 590, "fuel": 420, "xp": 13000, "ticket": 43, "range": 5, "has_world_sprite": true},
	...
	{"key": "p51", "name": "P-51 Mustang", "icon": "p51_white.png", "price": 125, "currency": COINS, "level": 45,
		"force": "E", "seats": 2, "fuel": 420, "xp": 40000, "ticket": 22500, "range": 5, "has_world_sprite": true},
	{"key": "blackh", "name": "Black Hawk", "icon": "blackh_green.png", "price": 180, "currency": COINS, "level": 48,
		"force": "B", "seats": 340, "fuel": 105, "xp": 53000, "range": 4, "has_world_sprite": true},
	...
	{"key": "a340-300", "name": "A340-300", "icon": "a340-300_default.png", "price": 15000000, "level": 49,
		"force": "E", "seats": 560, "fuel": 440, "xp": 24000, "ticket": 75, "range": 5, "has_world_sprite": true},
	...
	{"key": "il114", "name": "Il-114", "icon": "il114_default.png", "price": 18000000, "level": 50,
		"force": "D", "seats": 460, "fuel": 410, "xp": 31000, "ticket": 100, "range": 5, "has_world_sprite": true},
	...
	{"key": "a400m", "name": "A400M", "icon": "a400m_white.png", "price": 18000000, "level": 50,
		"force": "D", "seats": 500, "fuel": 410, "xp": 31000, "ticket": 100, "range": 5, "has_world_sprite": true},
	{"key": "ark", "name": "Ark", "icon": "ark_default.png", "price": 22000000, "level": 50,
		"force": "A", "seats": 1000, "fuel": 300, "xp": 35000, "ticket": 60, "range": 5, "has_world_sprite": true},
	...
	{"key": "x37b", "name": "X-37B", "icon": "x37b_default.png", "price": 200, "currency": COINS, "level": 50,
		"force": "S", "seats": 4, "fuel": 260, "xp": 58000, "ticket": 2000, "range": 5, "has_world_sprite": true},
	# ---- levels 51-60 ------------------------------------------------
	...
	{"key": "an74", "name": "An-74", "icon": "an74_default.png", "price": 26000000, "level": 52,
		"force": "D", "seats": 420, "fuel": 410, "xp": 40000, "ticket": 105, "range": 5, "has_world_sprite": true},
	{"key": "lc130", "name": "LC-130", "icon": "lc130_default.png", "price": 31000000, "level": 53,
		"force": "D", "seats": 470, "fuel": 420, "xp": 45000, "ticket": 100, "range": 5, "has_world_sprite": true},
	...
	{"key": "c17", "name": "C-17", "icon": "c17_default.png", "price": 220, "currency": COINS, "level": 53,
		"force": "D", "seats": 620, "fuel": 420, "xp": 62000, "range": 5, "has_world_sprite": true},
	...
	{"key": "be200", "name": "Be-200", "icon": "be200_default.png", "price": 37000000, "level": 55,
		"force": "D", "seats": 480, "fuel": 430, "xp": 51000, "ticket": 100, "range": 5, "has_world_sprite": true},
	{"key": "us2", "name": "US-2", "icon": "us2_default.png", "price": 44000000, "level": 55,
		"force": "D", "seats": 500, "fuel": 430, "xp": 59000, "ticket": 100, "range": 5, "has_world_sprite": true},
	{"key": "an158", "name": "An-158", "icon": "an158_default.png", "price": 50000000, "level": 55,
		"force": "D", "seats": 500, "fuel": 430, "xp": 63000, "ticket": 100, "range": 5, "has_world_sprite": true},
	...
	{"key": "f16", "name": "F-16", "icon": "f16_default.png", "price": 53000000, "level": 57,
		"force": "S", "seats": 10, "fuel": 280, "xp": 66000, "ticket": 5500, "range": 5, "has_world_sprite": true},
	{"key": "b314", "name": "314 Clipper", "icon": "b314_default.png", "price": 64000000, "level": 57,
		"force": "E", "seats": 560, "fuel": 470, "xp": 75000, "ticket": 95, "range": 5, "has_world_sprite": true},
	...
	{"key": "spirit", "name": "Spirit of St. Louis", "icon": "spirit_default.png", "price": 240, "currency": COINS, "level": 58,
		"force": "B", "seats": 6, "fuel": 360, "xp": 67000, "ticket": 3000, "range": 5, "has_world_sprite": true},
	...
	{"key": "guppy", "name": "Super Guppy", "icon": "guppy_default.png", "price": 77000000, "level": 59,
		"force": "E", "seats": 590, "fuel": 480, "xp": 86000, "ticket": 92, "range": 5, "has_world_sprite": true},
	...
	{"key": "skylink", "name": "Skylink", "icon": "skylink_default.png", "price": 92000000, "level": 60,
		"force": "D", "seats": 620, "fuel": 440, "xp": 98000, "ticket": 90, "range": 5, "has_world_sprite": true},
	# ---- levels 61-70 ------------------------------------------------
	...
	{"key": "b737", "name": "737", "icon": "b737_default.png", "price": 110000000, "level": 61,
		"force": "D", "seats": 600, "fuel": 450, "xp": 110000, "ticket": 96, "range": 5, "has_world_sprite": true},
	{"key": "dreamlifter", "name": "Dreamlifter", "icon": "dreamlifter_default.png", "price": 130000000, "level": 65,
		"force": "D", "seats": 660, "fuel": 460, "xp": 110000, "ticket": 88, "range": 5, "has_world_sprite": true},
	...
	{"key": "h4", "name": "H-4", "icon": "h4_default.png", "price": 140000000, "level": 66,
		"force": "E", "seats": 700, "fuel": 510, "xp": 130000, "ticket": 85, "range": 5, "has_world_sprite": true},
	...
	{"key": "harrier", "name": "AV-8B", "icon": "harrier_default.png", "price": 160000000, "level": 68,
		"force": "A", "seats": 12, "fuel": 350, "xp": 140000, "ticket": 4500, "range": 5, "has_world_sprite": true},
	...
	{"key": "e2", "name": "E-2", "icon": "e2_default.png", "price": 180000000, "level": 69,
		"force": "D", "seats": 25, "fuel": 480, "xp": 170000, "ticket": 2300, "range": 5, "has_world_sprite": true},
	...
	{"key": "f14", "name": "F-14", "icon": "f14_default.png", "price": 210000000, "level": 70,
		"force": "S", "seats": 20, "fuel": 310, "xp": 190000, "ticket": 3000, "range": 5, "has_world_sprite": true},
	# ---- levels 81-90 ------------------------------------------------
	...
	{"key": "a380-800", "name": "A380-800", "icon": "a380-800_default.png", "price": 400, "currency": COINS, "level": 84,
		"force": "E", "seats": 1400, "fuel": 600, "xp": 99000, "ticket": 80, "range": 5, "has_world_sprite": true},
]

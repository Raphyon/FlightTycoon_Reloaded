...
# tools/plane_derive.py and tools/blackhawk_derive.py). The remaining
# false ones - A400M, Airship, Ark, UFO - are shop-icon only: shown in the
# shop since we have the art, but not purchasable until a world sprite
# exists for them.
const ENTRIES := [
	...
	{"key": "a400m", "name": "A400M", "icon": "a400m_white.png", "price": 2600, "has_world_sprite": false},
